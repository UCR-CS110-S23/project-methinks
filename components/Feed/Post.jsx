...
const Post = ({ id, image, username, date, text, tag }) => {
  ...
  return (
    <Link
      href={`/feed/${id}`}
      className="flex justify-center drop-shadow-xl hover:shadow-2xl hover:scale-x-[1.0033] hover:shadow-methinks-black duration-300 cursor-pointer rounded-xl font-publicSans no-underline"
    >
