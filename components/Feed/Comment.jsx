...
const Comment = ({ image, username, date, text }) => {
  return (
    <div className="bg-gray-200 w-full flex flex-col rounded-xl gap-y-5 pt-4 pb-8 px-4">
      <div className="flex gap-x-4 items-center">
        <div className="text-[##77818A] text-base ">{image}</div>
